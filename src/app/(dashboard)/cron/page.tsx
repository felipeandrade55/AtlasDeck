      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-8">
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>Total</p>
          </div>
        </div>
        <div style={{
          backgroundColor: 'color-mix(in srgb, var(--card) 50%, transparent)',
          ...
          <div>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>Ativos</p>
          </div>
        </div>
        <div style={{
          backgroundColor: 'color-mix(in srgb, var(--card) 50%, transparent)',
          ...
          <div>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-secondary)' }}>Pausados</p>
          </div>
        </div>
      </div>
